...
## Installation
To build and install the sample application you will need the [AWS CLI](https://aws.amazon.com/cli/) installed on your computer.

In a shell, navigate to the sample's folder and use gradle to build a deployable zip.
```
$ ./gradlew clean build
```
